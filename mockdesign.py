...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, QtCore.QCoreApplication.translate("MainWindow", u"Speed", None))
        self.comboBox.setItemText(1, QtCore.QCoreApplication.translate("MainWindow", u"Time", None))
        self.comboBox.setItemText(2, QtCore.QCoreApplication.translate("MainWindow", u"Location", None))
